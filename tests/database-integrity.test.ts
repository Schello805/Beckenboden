...
test("creates all additive security and retention structures on a fresh database", () => {
  ...
  for (const table of ["attendance_archive", "account_tokens", "consent_history", "login_attempts", "push_subscriptions", "push_messages", "user_notifications", "passkey_credentials", "passkey_challenges"]) {
